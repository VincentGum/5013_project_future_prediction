...
def load_data(future_data):
    ...
    # data_train = future_data[0:4000]
    # value_train = value[0:4000]
    # data_predict = future_data[4000:L - 1]
    # value_real = value[4000:L - 1]
    # return data_train, value_train, data_predict, value_real
